...
export default function Bimbel() {
	return (
		<section className="col-span-1 lg:col-span-4 py-10 space-y-4">
			...
			<FeatureFunctionLink
				to="/bimbel/pesan-bimbel"
				title="Pesan Bimbel"
				icon={<PlusIcon className="w-[18px] h-[18px] text-zinc-700" />}
			/>
			<FeatureFunctionLink
				to="/bimbel/kalender"
				title="Kalender"
				icon={<CalendarDaysIcon className="w-[18px] h-[18px] text-zinc-700" />}
			/>
			<FeatureFunctionLink
				to="/bimbel/akan-datang"
				title="Jadwal Akan Datang"
				icon={<ClockIcon className="w-[18px] h-[18px] text-zinc-700" />}
			/>
			<FeatureFunctionLink
