  ...
  return (
    <div>
      <div
        title='Pencarian'
        onClick={openModal}
        className='py-1.5 sm:py-1 px-1.5 sm:pl-2 rounded-md group flex items-center hover:cursor-pointer md:space-x-1 duration-100 ease-out'
      >
        <SearchIcon
          strokeWidth={2}
          className='h-5 w-5 md:h-4 md:w-4 text-zinc-300 group-hover:text-blue-800 sm:group-hover:text-white group-active:text-blue-600'
        />
                  ...
                  <ul className='space-y-1 pl-4'>
                    <li>
                      <Link href='/matematika'>
                        <a className='text-zinc-400 hover:text-white block w-full'>Matematika</a>
                      </Link>
                    </li>
                    <li>
                      <Link href='/fisika'>
                        <a className='text-zinc-400 hover:text-white block w-full'>Fisika</a>
                      </Link>
                    </li>
                    <li>
                      <Link href='/bimbel'>
                        <a className='text-zinc-400 hover:text-white block w-full'>Bimbel</a>
                      </Link>
                    </li>
                    <li>
                      <Link href='/kalkulator'>
                        <a className='text-zinc-400 hover:text-white block w-full'>Kalkulator</a>
                      </Link>
                    </li>
                  </ul>
                </div>
