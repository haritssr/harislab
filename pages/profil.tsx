    ...
    >
      <div className='mx-auto max-w-sm space-y-5'>
        ...
        <section className='mx-auto max-w-sm'>
          ...
          {logged ? (
            <>
              <div className='font-medium text-zinc-700'>Bab yang sudah selesai dibaca</div>
              <div className='h-32 bg-zinc-200 rounded mb-3 flex items-center justify-center text-zinc-500'>
                Grafik
              </div>
              <div className='font-medium text-zinc-700'>Topik yang sudah selesai dibaca</div>
              <div className='h-32 bg-zinc-200 rounded mb-3 flex items-center justify-center text-zinc-500'>
                Grafik
              </div>
              <div className='font-medium text-zinc-700'>Topik yang sedang dibaca</div>
              <div className='h-32 bg-zinc-200 rounded mb-3 flex items-center justify-center text-zinc-500 p-4'>
                Daftar link menuju topik yang sedang dibaca, tepat pada bagian paragraph yang sedang
                dibaca
              </div>
