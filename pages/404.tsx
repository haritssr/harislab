  ...
  return (
    <Layout browserTitle="404" description="Kayanya kamu nyasar deh ^_^">
      <div className="flex flex-col items-center justify-center h-screen space-y-5 ">
        ...
        <Link
          href="/"
          className=" pr-4 pl-2 py-2 text-base text-blue-600 duration-200 bg-white hover:bg-blue-50 border rounded-full cursor-pointer  flex items-center border-blue-500"
        >
