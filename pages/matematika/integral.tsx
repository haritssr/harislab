...
import { AA1, A2, P, KaTeX, rumusTitle } from "@/components/DesignSystem";
    ...
    <LayoutMateri browserTitle="Integral" description="Materi Integral">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
        {IntegralRumus.map((a) => (
          <div
            key={a.nama}
            className="p-5 bg-white rounded-md shadow-md hover:shadow-lg"
          >
      ...
      <div className="grid grid-cols-1">
        {IntegralPenurunanRumus.map((a) => (
          <article
            key={a.nama}
            className="mb-3 overflow-x-auto rounded-md shadow hover:shadow-md"
          >
